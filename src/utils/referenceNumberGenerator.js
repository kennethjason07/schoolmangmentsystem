 ...
 */
const extractNamePrefix = (studentName) => {
 ...
 */
const checkReferenceNumberExists = async (referenceNumber, tenantId) => {
  try {
    ...
    console.error('Exception checking reference number uniqueness:', error);
 ...
 */
export const generateUniqueReferenceNumber = async (studentName, tenantId, maxAttempts = 100) => {
 ...
 */
export const validateReferenceNumberFormat = (referenceNumber) => {
 ...
 */
export const formatReferenceNumberForDisplay = (referenceNumber) => {
 ...
 */
export const generateMockReferenceNumber = (studentName) => {
