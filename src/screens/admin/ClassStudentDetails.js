          ...
          <body>
            ...
            <div class="content">
              ...
              <div>
                ...
                ${receiptData.cashier_name ? `<div class=\"row\"><span class=\"label\">Cashier:</span> ${receiptData.cashier_name}</div>` : ''}
              </div>
            </div>
            <div class=\"amount\">Amount Paid: ₹${receiptData.amount_paid?.toLocaleString() || '0.00'}</div>
            ${typeof receiptData.amount_remaining !== 'undefined' && receiptData.amount_remaining !== null ? `<div class=\"amount\">Amount Remaining: ₹${Number(receiptData.amount_remaining).toLocaleString()}</div>` : ''}
            ${receiptData.cashier_name ? `<div style=\"text-align:center; margin-top:10px; font-size: 12px; color: #666;\">This receipt was generated by: ${receiptData.cashier_name}</div>` : ''}
          </body>
        </html>
      `;
    }
