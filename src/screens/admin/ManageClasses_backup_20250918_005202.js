...
import { useTenantAccess, createTenantQuery } from '../../utils/tenantHelpers';
import { useAuth } from '../../utils/AuthContext';
import { getCurrentUserTenantByEmail } from '../../utils/getTenantByEmail';
import { validateTenantAccess, validateDataTenancy } from '../../utils/tenantValidation';
...
const ManageClasses = ({ navigation }) => {
        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              ...
              const { data: classSubjects } = await createTenantQuery('subjects', 'id', { class_id: classId });
  ...
  const openClassDetails = async (classItem) => {
    try {
      ...
      const { data: subjectsData, error: subjectsError } = await createTenantQuery(
        'subjects',
        `
          *,
          teacher_subjects(
