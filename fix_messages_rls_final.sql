...
-- 2. INSERT Policy: Users can insert messages within their tenant where they are the sender
...
-- 5. Admin Access Policy: Admins can access all messages within their tenant
...
-- Create or replace trigger for messages table to auto-set tenant_id
...
COMMENT ON FUNCTION public.get_user_tenant_id() IS 'Safely retrieves current user tenant ID from JWT or database';
