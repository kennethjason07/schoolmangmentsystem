-- ========================================
-- COMPLETE FIX FOR DISCOUNT_APPLIED COLUMN ISSUE
-- ========================================
...
-- Step 2: Find and list any triggers that might be causing issues
...
-- Step 3: Find functions that reference discount_applied
...
-- Step 4: Test discount insertion
